...
import mrtjp.fengine.tiles.{FEPortlessNestedFlatMapTile, FETile}

class PortlessNestedFlatMapTile(label:String, override val inDirMask:Int, override val outDirMask:Int, override val inputSignalMap:Map[Int, Int], override val outputSignalMap:Map[Int, Int], override val nestedFlatMap:ICFlatMap) extends FETile with FEPortlessNestedFlatMapTile with TTestFETile
{
