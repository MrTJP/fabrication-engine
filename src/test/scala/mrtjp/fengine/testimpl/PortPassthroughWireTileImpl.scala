...
import mrtjp.fengine.tiles.{FEPortPassthroughWireTile, FETile}

class PortPassthroughWireTileImpl(override val connMask:Int, override val portMask:Int) extends FETile with FEPortPassthroughWireTile with TTestFETile
{
